...
const PsytechChatbot = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const chatbotEndpoint = process.env.REACT_APP_CHAT_BOT_API || "https://chat-bot-chi-rose.vercel.app/prompt";
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="bg-blue-600 p-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-white">PsyTech AI Assistant</h1>
            </div>
            <button
              onClick={clearChat}
                  ...
                  >
                    ...
                    >
                      {msg.type === "user" ? (
                        ...
                        <Bot className="h-5 w-5 text-gray-700 text-red-900" />
                      )}
                    </div>
                    <div
            ...
            {isLoading && (
              <div className="flex gap-3 mb-4">
                <div className="bg-gray-200 rounded-full p-2">
                  <Bot className="h-5 w-5 text-gray-700 text-red-600" />
                </div>
